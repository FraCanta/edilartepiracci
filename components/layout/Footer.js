      ...
      <div className="w-full p-4 py-6 lg:py-8">
        <div className="gap-10 md:flex md:justify-between">
          ...
          <div className="grid justify-between w-full grid-cols-1 gap-8 sm:gap-6 md:grid-cols-3">
            <div className="pb-4 border-b-2 border-white md:pl-4 md:border-l-2">
              <h2 className="mb-6 text-sm font-medium uppercase text-heading">
                Edilarte piracci
              </h2>
              <ul className="flex flex-col gap-2 font-medium text-body">
                <li>
            ...
            <div className="pb-4 border-b-2 border-white md:pl-4 md:border-l-2">
              ...
              <ul className="flex flex-col w-full gap-2 font-medium text-body">
                <li className="mb-4">
                ...
                <li className="w-full">
                  <Link
                    href="/"
                    className="uppercase w-full bg-[#BCA70D] text-white px-[20px] py-[20px] text-center text-lg xl:text-sm lg:px-[42px] 2xl:text-base fxl:px-[60px] md:py-5"
                  >
                    prenota ora
                  </Link>
                </li>
            ...
            <div className="border-white md:pl-4 md:border-l-2">
              <h2 className="mb-6 text-sm font-semibold uppercase text-heading">
                Legal
              </h2>
